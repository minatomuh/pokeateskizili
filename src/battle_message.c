...
static const u8 sText_PkmnTrappedBySandTomb[] = _("{B_DEF_NAME_WITH_PREFIX}, KUM MEZAR\nile hapsoldu!");
...
static const u8 sText_PkmnUproarKeptAwake[] = _("Ama {B_SCR_ACTIVE_NAME_WITH_PREFIX}'ın KARGAŞA'sı\nonu uyutmuyor!");
static const u8 sText_PkmnWokeUpInUproar[] = _("{B_ATK_NAME_WITH_PREFIX} KARGAŞA ile\nuyandı!");
...
static const u8 sText_PkmnCantSleepInUproar[] = _("Ama {B_DEF_NAME_WITH_PREFIX} KARGAŞA\nvarken uyuyamıyor!");
...
static const u8 sText_PkmnCantSleepInUproar2[] = _("Ama {B_DEF_NAME_WITH_PREFIX}, KARGAŞA\nvarken uyuyamıyor!");
static const u8 sText_UproarKeptPkmnAwake[] = _("Ama KARGAŞA, {B_DEF_NAME_WITH_PREFIX}'ı\nuyanık tutuyor!");
...
static const u8 sText_CantEscape[] = _("Kaçamadın!\p");
static const u8 sText_DontLeaveBirch[] = _("Eğitmen savaşından kaçamazsın!\p");
...
const u8 gText_OakNoRunningFromATrainer[] = _("OAK: Bir eğitmene karşı yaptığın\nPOKéMON savaşından kaçamazsın!\p");
...
const u8 gText_APoisonMove[] = _("bir ZEHİR saldırısı");
